...
class PermitPolicy
{
    ...
    {
        return $user->can('view_any_permit');
    }
    ...
    {
        return $user->can('delete_any_permit');
    }
     ...
     */
    public function replicate(User $user, Permit $permit): bool
    {
